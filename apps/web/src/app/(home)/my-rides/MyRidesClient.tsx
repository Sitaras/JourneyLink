...
import { UserRideRole, UserRole } from "@journey-link/shared";
...
const MyRidesClient = () => {
  ...
  const activeTab =
    viewParam === UserRole.DRIVER
      ? UserRideRole.AS_DRIVER
  ...
  const handleTabChange = (value: string) => {
    const viewValue =
      value === UserRideRole.AS_DRIVER ? UserRole.DRIVER : UserRole.PASSENGER;
